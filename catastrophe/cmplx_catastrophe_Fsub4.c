		...
		double complex *const f)
{
	...
	U02 = 0.5 * (-VAR(K)) * (I * (l2 * y[V] - I * l3 * y[V1]) + STORAGE_COMPLEX(Ai));

	U01 = 0.5 * VAR(K) * (I * STORAGE_COMPLEX(Aid) - l2 * y[V1] + I/3.0 * l3 *
			(l1 * y[V] - I * l3 * U02));

	U22 = 0.5 * VAR(K) / I * (1.0 + l2 * U02 + l3 * U01);
